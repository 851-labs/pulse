...
function TooltipShowcase() {
  return (
    <div className="max-w-4xl">
      ...
      <section className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Basic Usage</h2>
  ...
  <Tooltip.Content>
    This is a helpful tooltip
      ...
      {/* Positioning Section */}
      <section className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Positioning</h2>
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
...
<Tooltip>
  ...
  <Tooltip.Content side="right">Right tooltip</Tooltip.Content>
      ...
      <section className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Different Content Types</h2>
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
...
<Tooltip>
  ...
  <Tooltip.Content>This is a much longer tooltip...</Tooltip.Content>
</Tooltip>
...
<Tooltip>
  ...
  <Tooltip.Content>🎉 Emojis work too!</Tooltip.Content>
      ...
      <section className="mb-12">
        <h2 className="mb-6 text-2xl font-semibold text-gray-900">Interactive Examples</h2>
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
